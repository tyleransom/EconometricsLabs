...
Otherwise, need \textbf{asymptotics} to do hypothesis testing of  $\beta$'s

\section{Testing Hypotheses about the $\beta$'s}
Under A (1)--(6),\footnote{Or, A (1)--(5) combined with asymptotic properties} can test hypotheses about the $\beta$'s
...
\begin{enumerate}
    \item $cov\left(z,u\right) = 0$ (testable)
    \item $cov\left(z,x\right) \neq 0$ (\textbf{not} testable)
\end{enumerate}
